        ...
        <ul class="nav nav-tabs nav-justified mb-3" id="ex1" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <a
              ...
              aria-selected="false"
              >Data Usaha Mikro, Kecil, dan Menengah Warga Kelurahan</a
            >
          </li>
        </ul>
        <!-- Tabs navs -->
        ...
        <div class="tab-content" id="ex2-content">
          ...
          <div class="row row-cols-1 row-cols-md-4 g-4 justify-content-center" >
            ...
            <div class="card" style="width: 18rem;">
              <img src="@if ($item->gambar === NULL) /images/umkm.jpg @else {{asset('storage/'.$item->gambar)}}  @endif" width="262" height="183">
              <div class="card-body">
                <h5 class="card-title">{{$item->produk}}</h5>
              </div>
              <ul class="list-group list-group-flush">
                <li class="list-group-item">Nama Pemilik : {{$item->pemilik}}</li>
                <li class="list-group-item">Nomor HP : {{$item->nomor}}</li>
                <li class="list-group-item">Alamat : {{$item->alamat}}</li>
              </ul>
              <div class="card-body">
                <a href="{{$item->gmaps}}" class="card-link">Tempat</a>
              </div>
            </div>
            @endforeach
        </div>
