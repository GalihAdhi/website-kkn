...
@section('content')
  <div class="container p-3">
    <div class="row mt-3 mb-3 text-center">
      <h3 class="text-uppercase">artikel seputar Desa Kismoyoso</h3>
    ...
    <div class="row mb-3 justify-content-center">
      ...
      <div class="col-lg-4 mb-3 h-100">
        <div class="card" style="width: 18rem;">
          <img src="@if($artikel[$i]->gambar) {{asset('storage/'.$artikel[$i]->gambar)}} @else https://source.unsplash.com/1600x900/?{{$artikel[$i]->judul}} @endif" class="card-img-top" alt="...">
          <div class="card-body">
