    ...
    <div class="container card shadow mt-3 mb-3 p-3">
      ...
      @if (!count($data_profesi))
        <div class="row justify-content-center mb-3">
          <div class="col-lg-6 text-center">
            ...
            <h4>Ups! Tidak ada data UMKM</h4>
            <a href="/admin/data_profesi/create" class="btn text-light" style="background-color: #F88154"><i class="bi bi-plus me-2"></i>Tambah Data UMKM</a>
          </div>
        </div>
      @else
        <div class="row mb-3">
          <div class="col-lg-6">
            <h5 class="text-uppercase">data umkm</h5>
          </div>
          <div class="col-lg-6 text-end">
            <a href="/admin/data_profesi/create" class="btn text-light" style="background-color: #F88154"><i class="bi bi-plus me-1"></i>Tambah</a>
          </div>
        </div>
      ...
      <div class="row justify-content-center mb-3">
        <div class="col-lg-6 text-center">
          ...
          <a href="/admin/data_umum/create" class="btn text-light" style="background-color: #F88154"><i class="bi bi-plus me-2"></i>Tambah data warga</a>
        </div>
      </div>
      @else
      <div class="row mb-3">
        ...
        <div class="col-lg-6 text-end">
          <a href="/admin/data_umum/create" class="btn text-light" style="background-color: #F88154"><i class="bi bi-plus me-1"></i>Tambah</a>
        </div>
      </div>
      <div class="row mb-3 justify-content-center">
        <div class="col-lg-10">
