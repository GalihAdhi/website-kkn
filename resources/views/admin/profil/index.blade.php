      ...
      <!-- Tabs navs -->
        ...
        <div class="tab-content" id="ex2-content">
            ...
            <div class="container">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <button data-bs-target="#ubahGeoModal" data-bs-toggle="modal" class="btn text-light" style="background-color: #F88154"><i class="bi bi-pen me-2"></i>Ubah</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="container">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <button data-bs-target="#ubahEkoModal" data-bs-toggle="modal" class="btn text-light" style="background-color: #F88154"><i class="bi bi-pen me-2"></i>Ubah</button>
              </div>
            </div>
          </div>
          </div>
          ...
          <div class="container">
            <div class="row mb-2">
              <div class="col-lg-6">
                <h6 class="text-capitalize">sarana dan prasarana Desa</h6>
              </div>
              <div class="col-lg-6 text-end">
                <a href="/admin/infrastruktur/create" class="btn text-light shadow" style="background-color: #F88154"><i class="bi bi-plus me-2"></i>Tambah</a>
              </div>
            </div>
              ...
              @if (!count($foto))
                <div class="row justify-content-center">
                  <div class="col-lg-6 text-center">
                    ...
                    <a href="/admin/foto/create" class="btn text-light" style="background-color: #F88154"><i class="bi bi-plus me-2"></i>Tambah</a>
                  </div>
                </div>
              @else
                <div class="row mb-3">
                  ...
                  <div class="col-lg-6 text-end">
                    <a href="/admin/foto/create" class="btn text-light" style="background-color: #F88154"><i class="bi bi-plus me-1"></i>Tambah</a>
                  </div>
                </div>
