<nav class="navbar navbar-expand-lg navbar-dark rounded" style="background-color: #F88154 ">
  <div class="container-fluid">
    <a class="navbar-brand text-white" href="/"><b>Desa Kismoyoso</b></a>
      ...
      <div class="navbar-nav ms-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="pemerintahanDropDown">
            ...
            <li><a class="dropdown-item" href="/pemerintahan/struktur">Pemerintahan Desa Kismoyoso</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown">
        ...
        <a class="nav-link text-light" href="/data">Data Desa Kismoyoso</a>
        @if (!auth()->user())
          <a class="nav-link btn btn-sm text-light ms-2 shadow" href="/masuk" style="background-color: #F55315">Masuk <i class='bx bx-log-in'></i></a>
        @else
