<div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px;">
  ...
  <ul class="nav nav-pills flex-column mb-auto fs-5 sticky-top">
    ...
    <li>
      <a href="/admin/profil_desa" class="nav-link link-dark" @if($title === 'Profil Desa') style="background-color: #F88154; color:antiquewhite" @endif>
        <i class="bi bi-geo-alt me-2"></i>Profil Desa
      </a>
    </li>
    <li>
      <a href="/admin/kelembagaan" class="nav-link link-dark" @if($title === 'Kelembagaan Desa') style="background-color: #F88154; color:antiquewhite" @endif>
        <i class="bi bi-people me-2"></i>Kelembagaan
      </a>
    </li>
    <li>
      <a href="/admin/data_desa" class="nav-link link-dark" @if($title === 'Data Desa Kismoyoso') style="background-color: #F88154; color:antiquewhite" @endif>
        <i class="bi bi-clipboard-data me-2"></i>Data Desa Kismoyoso
      </a>
    </li>
    {{-- <li>
      <a href="/admin/data_desa" class="nav-link link-dark" @if($title === 'Data Desa dan UMKM Kismoyoso') style="background-color: #F88154; color:antiquewhite" @endif>
        <i class="bi bi-clipboard-data me-2"></i>Data Desa dan UMKM Kismoyoso
      </a>
    </li> --}}
  </ul>
